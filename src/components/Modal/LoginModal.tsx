...
const LoginModalProps = ({ isOpen, onClose }: LoginModalProps) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-40 flex justify-center items-center z-50">
      <div className="bg-white bg-opacity-70 rounded-2xl shadow-[0px_0px_2px_0px_rgba(0,0,0,0.05),4px_4px_20px_0px_rgba(0,0,0,0.05)] flex flex-col backdrop-blur-sm max-w-full h-auto px-10 pt-10 pb-6 z-50">
        <div className="flex flex-col text-center">
          <button
            title="x-icon"
            onClick={onClose}
            className="flex justify-end rounded-full hover:bg-[#4d4d4d]/50"
          >
