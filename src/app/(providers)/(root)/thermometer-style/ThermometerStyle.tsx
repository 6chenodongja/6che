  ...
  return (
    <div className="w-full max-w-md mx-auto flex flex-col items-center justify-center min-h-screen bg-white">
      <div className="flex flex-col items-center mt-4 mb-8">
        ...
        <div className="relative">
          <div className="grid grid-cols-2 gap-4 mb-6">
            {currentOutfits.map((src: string, index: number) => (
              <div
                key={index}
                className="flex flex-col items-center justify-center gap-2 p-4 w-48 h-64 bg-white shadow rounded-lg bg-opacity-40 backdrop-blur-lg border border-white relative"
              >
                {!initialView && (
        ...
        <div
          ref={sliderRef}
          className="relative w-80 h-14 flex items-center justify-center mb-8 overflow-hidden"
          onMouseMove={isDragging ? handleDrag : undefined}
          onTouchMove={isDragging ? handleDrag : undefined}
          onMouseDown={handleMouseDown}
          onTouchStart={handleMouseDown}
