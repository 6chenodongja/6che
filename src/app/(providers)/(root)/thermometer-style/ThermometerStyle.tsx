...
const ThermometerStyle: React.FC = () => {
  ...
  const getTopLeftImage = () => {
    switch (temperatureRanges[temperatureIndex].display) {
      case '28° 이상':
        return '/images/Weather2/parasol.svg';
      case '20° - 22°':
        return '/images/Weather2/straw_hat.svg';
      case '17° - 19°':
        return '/images/Weather2/ginkgo_leaf.svg';
      default:
        return '/images/Weather2/sun.svg';
    }
  };
  ...
  const getBottomRightImage = () => {
    switch (temperatureRanges[temperatureIndex].display) {
      case '28° 이상':
        return '/images/Weather2/tube.svg';
      case '20° - 22°':
        return '/images/Weather2/sun.svg';
      case '17° - 19°':
        return '/images/Weather2/leaf.svg';
      default:
        return '/images/Weather2/leaf.svg';
    }
  };
  ...
  return (
    <div className="w-full max-w-md mx-auto flex flex-col min-h-screen bg-[#FFFFF]">
      {/* 모바일 화면 */}
      <div className="sm:hidden flex flex-col items-center mt-5 mb-8">
        <div
          className="relative mb-4 mt-10 temperature-display-container"
          style={{
            marginTop: '-40px',
      ...
      {/* 데스크탑 화면 */}
      <div className="hidden md:flex w-full min-h-screen bg-[#fafafa] justify-center items-center">
        <div className="w-[620px] h-[889px] bg-white rounded-3xl shadow-lg p-10 flex flex-col items-center justify-center">
          <div
            className="relative mb-4 mt-10 temperature-display-container"
            style={{
              marginTop: '-40px',
          ...
          <div className="relative w-full grid grid-cols-2 gap-[8px] px-[40px] py-[25px]">
            ...
            {currentOutfits
              ...
              .map((outfit, index) => (
                <div
                  key={index}
                  className={`relative w-[140px] h-[160px] bg-white/40 rounded-2xl shadow border border-white backdrop-blur-[20px] flex flex-col items-center justify-center`}
                >
                  {outfit.imageSrc ? (
