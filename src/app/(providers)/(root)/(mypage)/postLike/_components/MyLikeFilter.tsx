    ...
    <div>
      <div className="relative z-10 flex justify-center md:hidden">
        <div className="flex justify-between items-center shrink-0 w-[304px] p-2">
          ...
          {showDropdown && (
            <div className="absolute top-[48px] w-[288px] h-[165px] rounded-lg border border-opacity-50 flex flex-col items-start p-2 z-20 backdrop-blur-[5px] bg-white bg-opacity-90">
