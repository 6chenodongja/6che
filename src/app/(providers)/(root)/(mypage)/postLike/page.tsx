...
import ListSelects from '../../(post)/list/_components/ListSelect';
...
function PostLike() {
  ...
  return (
    <div className="container h-[1357px] bg-[#FAFAFA]">
      <Header />
      ...
      <div className="myPage-style mt-[46px] ml-[53px] mr-[52px] flex justify-center w-[215px] gap-0">
        좋아요를 한 스타일이 없어요
      </div>
      <Link href={'/list'}>
