        ...
        <div className="flex justify-center items-center shrink-0 gap-[175px] p-2">
          ...
          <div className="flex justify-center items-center top-[9px]">
            {checkItems.length === 0 ? (
              ...
              <button
                onClick={clickModal}
                className="rounded-lg px-[10px] py-[6px] flex justify-center items-center text-[#FFF] text-[14px] font-KR font-medium mr-3 transition duration-100 hover:bg-[#5EB0FF] bg-[rgba(255,71,50,0.85)]"
              >
                삭제
              </button>
            )}
