...
const IconLocation = () => (
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth="2"
      d="M12 2C8.686 2 6 4.686 6 8c0 3.314 3.134 7.856 5.034 10.018a1.002 1.002 0 001.932 0C14.866 15.856 18 11.314 18 8c0-3.314-2.686-6-6-6z"
    />
  </svg>
);
...
const MainPage = () => {
  ...
  // 요소 선택 핸들러
  const handleElementSelection = useCallback((elements: string[]) => {
    setSelectedWeatherElements(elements); // 선택된 요소들을 상태로 관리
    setShowModal(false);
  }, []);
    ...
    <div className="container bg-neutral-50 flex flex-col justify-center items-center w-full">
      ...
      {showModal && (
        <BottomSheet
          ...
          selectedElements={selectedWeatherElements} // 현재 선택된 요소를 전달
        />
      )}
    </div>
  );
