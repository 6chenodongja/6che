    ...
    <div className="w-full max-w-[320px] mx-auto flex flex-col items-center min-h-[636px] bg-[#fafafa] mt-10 px-4">
      <div className="w-full">
        ...
        <form onSubmit={handleSubmit} className="w-full">
          ...
          <button
            type="submit"
            className={`w-full py-2 rounded-lg ${email && (domain !== '직접 입력' || customDomain) ? 'bg-black text-white hover:bg-blue-400' : 'bg-black-100 text-black-300'}`}
            disabled={!email || (domain === '직접 입력' && !customDomain)}
          >
            계정 확인
          </button>
        </form>
