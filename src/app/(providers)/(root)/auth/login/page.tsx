  ...
  return (
    <main className="w-80 h-[1486px] relative overflow-hidden bg-white">
      ...
      <div className="flex flex-col justify-start items-start w-72 absolute left-4 top-[207px] pb-3">
        ...
        <div className="self-stretch flex-grow-0 flex-shrink-0 h-[42px] opacity-50 rounded-lg bg-[#d9d9d9]" />
      </div>
      ...
      <p className="absolute left-[135px] top-[435px] text-lg font-medium text-left text-black">
        로그인
      </p>
      ...
      <p className="absolute left-[145px] top-[613px] text-base text-left text-black">
        구글
      </p>
      <p className="absolute left-[130px] top-[671px] text-base text-left text-black">
        카카오톡
      </p>
      <p className="absolute left-[145px] top-[729px] text-base text-left text-black">
        애플
      </p>
