  ...
  return (
    <div>
      ...
      <div className="hidden md:flex">
        <div
          className="md:w-[800px] md:h-[500px] md:bg-[#FFF] md:backdrop-blur-[5px] md:mt-[85px] mx-auto"
          style={{
            boxShadow:
              ...
              <SwiperSlide key={image}>
                {image && (
                  <Image
                    ...
                    height={100}
                    sizes="100vw"
                    className="w-[288px] h-[412px] rounded-xl flex justify-start items-center my-[24px] ml-[20px] relative"
                  />
                )}
                <div className="absolute top-8 left-7 bg-white bg-opacity-50 p-1 m-1 font-[18px] rounded-lg flex flex-row gap-2 justify-center items-center">
                  {weatherIcon && (
                    <div className="detail-icon">
                      <Image
                        src={weatherIcon}
